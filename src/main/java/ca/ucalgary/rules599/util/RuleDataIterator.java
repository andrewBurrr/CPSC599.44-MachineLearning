...
public class RuleDataIterator implements Iterator<Transaction<AccidentAttribute>> {
        /**
        ...
        public static class TransactionImplementation implements Transaction<AccidentAttribute> {
            ...
            public Iterator<AccidentAttribute> iterator() {
                return new RuleDataIterator.LineIterator(line, this.type);
            }
        ...
        private static class LineIterator implements Iterator<AccidentAttribute> {
            ...
            LineIterator(@NotNull final String line, int type) {
                ...
                ensureNotEmpty(line, "The line may not be empty");
                ensureNotNull(type, "The line may not be null");
                this.tokenizer = new StringTokenizer(line.replace("[","").replace("]",""), ",");
            }
            ...
            public AccidentAttribute next() {
                ...
                return AccidentAttribute.builder().name(token).build();
            }
         ...
         */
        private static final Logger LOGGER = LoggerFactory.getLogger(ca.ucalgary.rules599.util.DataIterator.class);
         ...
         */
        public RuleDataIterator(@NotNull final File file,int type, boolean skipFirstLine) {
        ...
        public final Transaction<AccidentAttribute> next() {
            if (hasNext()) {
                Transaction<AccidentAttribute> transaction = new ca.ucalgary.rules599.util.DataIterator.TransactionImplementation(nextLine,this.type);
                nextLine = null;
                return transaction;
            }
